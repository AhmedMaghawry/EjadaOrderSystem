...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        TextView txt_store = (TextView) convertView
                .findViewById(R.id.store);
//
//        FloatingActionButton tick = convertView.findViewById(R.id.tick);
//        FloatingActionButton tock = convertView.findViewById(R.id.tock);

        String[] r = childText.split(":");

        txtListChild.setText(r[1]);
        txt_store.setText(r[0]);
        return convertView;
    }
